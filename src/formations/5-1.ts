  ...
  receive: {
    ...
    0: {
      ...
      'pass': [
        ...
        ZONE_1_SERVE_RECEIVE, // P2 outside
        { x: -3, y: 1.48 }, // P3 middle-blocker
        { x: -3.63, y: 2.44 }, // P4 opposite
        ZONE_5_SERVE_RECEIVE, // P5 outside
        ZONE_6_SERVE_RECEIVE, // P6 libero
      ],
      'set': [
        CONVENTIONAL_SETTING_POSITION, // P1 setter
        LEFT_PIN_ATTACK_APPROACH, // P2 outside
        MIDDLE_QUICK_APPROACH, // P3 middle-blocker
        RIGHT_PIN_ATTACK_APPROACH, // P4 opposite
        PIPE_ATTACK_APPROACH, // P5 outside
    ...
    1: {
      ...
      'pass': [
        ZONE_1_SERVE_RECEIVE, // P1 outside
        { x: 0, y: 1.48 }, // P2 middle-blocker
        { x: -3.63, y: 2.44 }, // P3 opposite
        ZONE_5_SERVE_RECEIVE, // P4 outside
        ZONE_6_SERVE_RECEIVE, // P5 libero
        { x: 3.63, y: 6.31 }, // P6 setter
      ],
      'set': [
        PIPE_ATTACK_APPROACH, // P1 outside
        MIDDLE_QUICK_APPROACH, // P2 middle-blocker
        RIGHT_PIN_ATTACK_APPROACH, // P3 opposite
        LEFT_PIN_ATTACK_APPROACH, // P4 outside
    ...
    2: {
      ...
      'set': [
        ...
        LEFT_PIN_ATTACK_APPROACH, // P3 outside
        MIDDLE_QUICK_APPROACH, // P4 middle-blocker
        CONVENTIONAL_SETTING_POSITION, // P5 setter
        PIPE_ATTACK_APPROACH, // P6 outside
      ],
      'attack': [
